...
const ResultsChainSelect = props => {
  ...
  return (
    <FormGroup inline>
      ...
      <Input type="select" name="select" id="exampleSelect" onChange={props.onSelect}>
        <option value="__null">{formatMessage({ id: 'resultschain.select.option.select' })}</option>
        <option value="__new">{formatMessage({ id: 'resultschain.select.option.new' })}</option>
